...
app.post("/notes", (req, res) => {
  const { id: subsub_id, title, content } = req.body;
  // console.log("req.body:", req.body);
  // console.log("subsub_id:", subsub_id);
  // console.log("title:", title);
  // console.log("content:", content);
  if (!subsub_id || !title || !content) {
    return res.status(400).send("subsub_id, title and content are required");
  }

  let post = { title, content, subsubcategory_id: subsub_id };
