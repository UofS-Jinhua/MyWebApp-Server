...
app.post("/notes", (req, res) => {
  const { title, content, images, files, subsubcategory_id } = req.body;

  if (!title || !content || !images || !files || !subsubcategory_id) {
    return res
      .status(400)
      .send(
        "title, content, images, files, and subsubcategory_id are required"
      );
  }
